...
module.exports = {
    "initialize": function(options = {}) {
        ...
        db.serialize(function() {
            ...
            db.run(`CREATE TABLE IF NOT EXISTS Reactions(postId INTEGER, userId INTEGER, emoji TEXT, PRIMARY KEY(postId, userId, emoji), CONSTRAINT fk_reactions_post_id FOREIGN KEY (postId) REFERENCES Posts(id) ON DELETE CASCADE, CONSTRAINT fk_reactions_user_id FOREIGN KEY (userId) REFERENCES Users(id) ON DELETE CASCADE)`);
            db.run(`CREATE TABLE IF NOT EXISTS Flags(postId INTEGER, userId INTEGER, flagType INTEGER, PRIMARY KEY(postId, userId), CONSTRAINT fk_flags_post_id FOREIGN KEY (postId) REFERENCES Posts(id) ON DELETE CASCADE, CONSTRAINT fk_flags_user_id FOREIGN KEY (userId) REFERENCES Users(id) ON DELETE CASCADE)`);
        });
    },
